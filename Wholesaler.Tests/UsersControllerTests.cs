...
public class UsersControllerTests : WholesalerWebTest
{
    ...
    [Fact]
    public async Task Login_WithValidData_ReturnsUserDtoAsync()
    {
        //Arrange
    ...
    [Fact]
    public async Task Login_WithInvalidData_ReturnsBadRequestAsync()
    {
        //Arrange
        var loginRequestModel = new LoginUserRequestModel()
        {
    ...
    [Fact]
    public async Task Login_WithInvalidPassword_ReturnsBadRequestAsync()
    {
        //Arrange
        var person = _personBuilder
            .WithRole(Role.Employee)
    ...
    [Fact]
    public async Task AddPerson_WithValidModel_ReturnsUserDtoAsync()
    {
        //Arrange
    ...
    [Fact]
    public async Task AddPerson_WithNoPassword_ReturnsBadRequestAsync()
    {
        //Arrange
        var addRequestModel = new AddPersonReqestModel()
        {
